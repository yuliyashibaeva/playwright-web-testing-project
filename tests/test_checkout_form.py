...
class TestCheckoutForm:
    ...
    @allure.title("Checkout shouldn't be successful without required field: {missing_input}")
    def test_checkout_should_fail_without_required_field(self, login_page, product_list_page, cart_page, checkout_page,
        ...
        checkout_page.fill_in_customer_info(customer_data.first_name, customer_data.last_name,
                                            customer_data.postal_code, missing_input)
